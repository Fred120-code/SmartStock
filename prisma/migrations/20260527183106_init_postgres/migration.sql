...
-- AddForeignKey
ALTER TABLE "StockAlert" ADD CONSTRAINT "StockAlert_associationId_fkey" FOREIGN KEY ("associationId") REFERENCES "Association"("id") ON DELETE SET NULL ON UPDATE CASCADE;
